...
export type HeroBannerMetaobjectsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type HeroBannerMetaobjectsQuery = {
  metaobjects: {
    nodes: Array<{
      fields: Array<
...
export type SelectedCollectionHomepageQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type SelectedCollectionHomepageQuery = {
  metaobjects: {
    nodes: Array<
...
interface GeneratedQueryTypes {
  '#graphql\nfragment Shop on Shop {\n    id\n    name\n    description\n    primaryDomain {\n      url\n    }\n    brand {\n      logo {\n        image {\n          url\n        }\n      }\n    }\n  }\n  query Header(\n  $country: CountryCode\n  $headerMenuHandle: String!\n  $language: LanguageCode\n) @inContext(language: $language, country: $country) {\n\n  shop {\n    ...Shop\n  }\n\n  menu(handle: $headerMenuHandle) {\n    ...Menu\n  }\n\n  topTextSettings: metaobjects(\n    type: "top_text_carousel_settings"\n    first: 1\n  ) {\n    nodes {\n      fields {\n        key\n        value\n      }\n    }\n  }\n\n  topTextItems: metaobjects(\n    type: "top_text_carousel_item"\n    first: 10\n  ) {\n    nodes {\n      fields {\n        key\n        value\n      }\n    }\n  }\n}\n  #graphql\n  fragment MenuItem on MenuItem {\n    id\n    resourceId\n    tags\n    title\n    type\n    url\n  }\n  fragment ChildMenuItem on MenuItem {\n    ...MenuItem\n  }\n  fragment ParentMenuItem on MenuItem {\n    ...MenuItem\n    items {\n      ...ChildMenuItem\n    }\n  }\n  fragment Menu on Menu {\n    id\n    items {\n      ...ParentMenuItem\n    }\n  }\n\n': {
    return: HeaderQuery;
  ...
  '#graphql\n  query HeroBannerMetaobjects {\n    metaobjects(type: "hero_banner_image", first: 1) {\n      nodes {\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              image {\n                url\n                altText\n                width\n                height\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: HeroBannerMetaobjectsQuery;
    variables: HeroBannerMetaobjectsQueryVariables;
  };
  '#graphql\nquery SelectedCollectionHomepage {\n  metaobjects(type: "homepage_selected_collection", first: 1) {\n    nodes {\n      id\n      fields {\n        key\n        references(first: 10) {\n          nodes {\n            ... on Collection {\n              id\n              title\n              handle\n              image {\n                url\n                altText\n                width\n                height\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n': {
    return: SelectedCollectionHomepageQuery;
    variables: SelectedCollectionHomepageQueryVariables;
  };
